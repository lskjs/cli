...
@lskjs/cli/2.8.0 darwin-x64 node-v15.8.0
$ lsk --help [COMMAND]
USAGE
  $ lsk COMMAND
...
...
_See code: [src/commands/info.js](https://github.com/lskjs/cli/blob/v2.8.0/src/commands/info.js)_
...
_See code: [src/commands/init.js](https://github.com/lskjs/cli/blob/v2.8.0/src/commands/init.js)_
...
_See code: [src/commands/link.js](https://github.com/lskjs/cli/blob/v2.8.0/src/commands/link.js)_
...
_See code: [src/commands/run.js](https://github.com/lskjs/cli/blob/v2.8.0/src/commands/run.js)_
...
_See code: [src/commands/update.js](https://github.com/lskjs/cli/blob/v2.8.0/src/commands/update.js)_
<!-- commandsstop -->
